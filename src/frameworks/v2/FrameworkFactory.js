 ...
 *
 * FASE 1: como el registro está vacío, `has()` devuelve siempre `false` y la
 * factory no altera ningún comportamiento. Es infraestructura inerte.
 */
...
const FrameworkFactory = {
   ...
   * @param {string} frameworkId
   * @param {string} architectureId
   * @returns {import('./BaseGenerator').BaseGenerator}
   */
   ...
   * @param {string} frameworkId
   * @param {string} architectureId
   * @returns {import('./BaseGenerator').BaseGenerator | null}
   */
